                           ...
                           uint32 Copy_uint32Group )           /*SCB_AIRCR REGISTER VALUE TO CHOSE PRIORITY DISTRIBUTION*/
{
	...
	uint8 Local_uint8Priority =  ( Copy_uint8SubGroupPriority | Copy_uint8GroupPriority << (( Copy_uint32Group - 0X05FFA0300) / 256 ));   /*THIS EQUATION TO GET FOUR BITS REPRESENT GROUP AND SUB GROUP PRIORITY*/
